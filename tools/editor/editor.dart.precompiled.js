...
["", "editor.dart", , E, {
  ...
  main: [function() {
    ...
    $.tdata = P.List_List$generate($.theight, new E.main_closure(), true, null);
    J.setInnerHtml$1$x(document.querySelector("#output"), C.C_JsonCodec.encode$1($.tdata));
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(E.saveData$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#load");
    t1.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(E.loadData$closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    ...
    t2 = H.setRuntimeTypeInfo(new W._EventStream(document, C.EventStreamProvider_mousemove._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(E.Mouse__moved$closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = H.setRuntimeTypeInfo(new W._EventStream(document, C.EventStreamProvider_mousedown._eventType, false), [null]);
    ...
    P.Timer_Timer(P.Duration$(0, 0, 0, $.interval, 0, 0), E.loop$closure());
  }, "call$0", "main$closure", 0, 0, 0],
  loop: [function() {
    var t1, t2, ctx;
    $.tx = C.JSNumber_methods._tdivFast$1($.Mouse_x, 30);
    $.ty = C.JSNumber_methods._tdivFast$1($.Mouse_y, 30);
    if ($.get$Keyboard__currentKeys().containsKey$1("48") || $.get$Keyboard__currentKeys().containsKey$1("192"))
      $.select = 0;
    if ($.get$Keyboard__currentKeys().containsKey$1("49"))
      $.select = 1;
    if ($.get$Keyboard__currentKeys().containsKey$1("50"))
      $.select = 2;
    if ($.get$Keyboard__currentKeys().containsKey$1("51"))
      $.select = 3;
    if ($.get$Keyboard__currentKeys().containsKey$1("52"))
      $.select = 4;
    if ($.get$Keyboard__currentKeys().containsKey$1("53"))
      $.select = 5;
    if ($.get$Keyboard__currentKeys().containsKey$1("54"))
      $.select = 6;
    if ($.get$Keyboard__currentKeys().containsKey$1("55"))
      $.select = 7;
    if ($.get$Keyboard__currentKeys().containsKey$1("56"))
      $.select = 8;
    if ($.get$Keyboard__currentKeys().containsKey$1("57"))
      $.select = 9;
    if ($.get$Keyboard__currentKeys().containsKey$1("80"))
      $.mode = 0;
    if ($.get$Keyboard__currentKeys().containsKey$1("70"))
      $.mode = 1;
    if ($.Mouse_down) {
      t1 = $.tx;
      if (typeof t1 !== "number")
    ...
    if (t1) {
      t1 = $.mode;
      if (t1 === 0)
        J.$indexSet$ax(J.$index$asx($.tdata, $.ty), $.tx, $.select);
      else if (t1 === 1) {
        $.mode = 0;
        t1 = $.tx;
        t2 = $.ty;
        E.fill(t1, t2, J.$index$asx(J.$index$asx($.tdata, t2), $.tx), $.select);
      }
    }
    t1 = $.view.canvas;
    J.get$context2D$x(t1).clearRect(0, 0, t1.width, t1.height);
    $.view.drawTiles$1($.tdata);
    ...
    if (typeof t2 !== "number")
      return t2.$mul();
    ctx.strokeRect(t1 * 30, t2 * 30, 30, 30);
    P.Timer_Timer(P.Duration$(0, 0, 0, $.interval, 0, 0), E.loop$closure());
  }, "call$0", "loop$closure", 0, 0, 0],
  fill: function(x, y, from, to) {
    var t1;
    if (!J.$eq(from, to)) {
      if (typeof x !== "number")
        return x.$ge();
      if (x >= 0)
        if (x < $.twidth) {
          if (typeof y !== "number")
            return y.$ge();
          t1 = y >= 0 && y < $.theight && J.$eq(J.$index$asx(J.$index$asx($.tdata, y), x), from);
        } else
          t1 = false;
      else
        t1 = false;
      ...
      t1 = false;
    if (t1) {
      J.$indexSet$ax(J.$index$asx($.tdata, y), x, to);
      if (typeof x !== "number")
        return x.$add();
      E.fill(x + 1, y, from, to);
      E.fill(x - 1, y, from, to);
      if (typeof y !== "number")
        return y.$add();
      E.fill(x, y + 1, from, to);
      E.fill(x, y - 1, from, to);
    }
  },
  saveData: [function(e) {
    J.setInnerHtml$1$x(document.querySelector("#output"), C.C_JsonCodec.encode$1($.tdata));
  }, "call$1", "saveData$closure", 2, 0, 10],
  loadData: [function(e) {
    $.tdata = C.C_JsonCodec.decode$1(J.get$value$x(document.querySelector("#output")));
  }, "call$1", "loadData$closure", 2, 0, 10],
  main_closure: {
    "": "Closure:24;",
    call$1: function(i) {
      return P.List_List$filled($.twidth, $.select, null);
    }
  }
},
1],
["util", "../../client/util/utils.dart", , E, {
  ...
  }, "call$1", "Keyboard__keyPressed$closure", 2, 0, 11],
  Keyboard__keyReleased: [function(e) {
    var t1 = $.get$Keyboard__currentKeys();
    t1.remove$1(t1, H.S(J.get$keyCode$x(e)));
  }, "call$1", "Keyboard__keyReleased$closure", 2, 0, 11],
  Mouse__moved: [function(e) {
    ...
    if (typeof t3 !== "number")
      return H.iae(t3);
    $.Mouse_y = t1 - t3;
  }, "call$1", "Mouse__moved$closure", 2, 0, 10],
  Mouse__pressed: [function(e) {
    $.Mouse_down = true;
  }, "call$1", "Mouse__pressed$closure", 2, 0, 10],
  Mouse__released: [function(e) {
    $.Mouse_down = false;
  }, "call$1", "Mouse__released$closure", 2, 0, 10],
  Viewport: {
    "": "Object;canvas",
    drawTiles$1: function(tdata) {
      var t1, tmp, t2, t3, t4, j, t5, i, t6;
      t1 = J.getInterceptor$ax(tdata);
      tmp = t1.toList$0(tdata);
      for (t2 = J.getInterceptor$asx(tmp), t3 = this.canvas, t4 = J.getInterceptor$x(t3), j = 0; j < t2.get$length(tmp); ++j) {
        t5 = j * 30;
        i = 0;
        while (true) {
          if (j >= tmp.length)
            return H.ioore(tmp, j);
          t6 = J.get$length$asx(tmp[j]);
          if (typeof t6 !== "number")
            return H.iae(t6);
          if (!(i < t6))
            break;
          switch (J.$index$asx(t1.$index(tdata, j), i)) {
            case 0:
              t4.get$context2D(t3).fillStyle = "white";
              break;
            case 1:
              t4.get$context2D(t3).fillStyle = "black";
              break;
            case 2:
              t4.get$context2D(t3).fillStyle = "gray";
              break;
            case 3:
              t4.get$context2D(t3).fillStyle = "orange";
              break;
            case 4:
              t4.get$context2D(t3).fillStyle = "lightblue";
              break;
            case 10:
              t4.get$context2D(t3).fillStyle = "Gold";
              break;
            default:
          }
          t4.get$context2D(t3).fillRect(i * 30, t5, 30, 30);
          ++i;
        }
      }
    }
